...
void readKeyboard(const KeyboardInputConfig & aConfig, ControllerInputState & aState, ApplicationGlfw & aApplication)
{
...
void GameInputState::readAll(ApplicationGlfw & aApplication)
{
